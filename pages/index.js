          ...
          <Table.Body>
            {searchResults.map((product) => (
              <Table.Row>
                ...
                <Table.Cell>{product.competitorPrices[0] && product.competitorPrices[0].price ? currencyFormatter.format(product.competitorPrices[0].price) : "No Stock"}</Table.Cell>
                <Table.Cell>{product.competitorPrices[1] && product.competitorPrices[1].price ? currencyFormatter.format(product.competitorPrices[1].price) : "No Stock"}</Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
        </Table>
